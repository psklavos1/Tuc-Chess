...
public class World {
	...
	public String selectActionMinimax() {
		availableMoves = new ArrayList<String>();

		if (myColor == 0) // I am the white player
			this.whiteMoves(board, availableMoves);
		else // I am the black player
			this.blackMoves(board, availableMoves);
		...
		new Minimax(this);
		BoardState boardState = new BoardState(board, scoreWhite, scoreBlack);
		long start = System.nanoTime();

		int[] minimaxRes = Minimax.minimaxExec(boardState, 10 , true, myColor, start);		
//		int[] minimaxRes = Minimax.minimaxExec(boardNode, 6, true, myColor, start,Integer.MIN_VALUE, Integer.MAX_VALUE);
		System.out.println("Elapsed Time: " + (System.nanoTime()-start)/1000000 + " ms");
		
		//System.out.println("Evaluation: "+ minimaxRes[1]);
		return availableMoves.get(minimaxRes[0]);
	}
	...
	public String selectActionAlphaBeta() {
		availableMoves = new ArrayList<String>();
		...
		// int[] minimaxRes = Minimax.minimaxExec(boardState, 6 , true, myColor, start);		
		int[] minimaxRes = Minimax.alphaBetaExec(boardState, 6, true, myColor, start,Integer.MIN_VALUE, Integer.MAX_VALUE);
		System.out.println("Elapsed Time: " + (System.nanoTime()-start)/1000000 + " ms");
	...
	public String selectActionMCTS() {
		availableMoves = new ArrayList<String>();
		...
		String bestMove = MCTS.MCTSExec(boardState, true, myColor, start);		
//		int[] minimaxRes = Minimax.minimaxExec(boardNode, 6, true, myColor, start,Integer.MIN_VALUE, Integer.MAX_VALUE);
		System.out.println("Elapsed Time: " + (System.nanoTime()-start)/1000000 + " ms");
