...
//	}
	...
	public static boolean whiteWins(BoardState state) {
		if(state.getWhiteScore()-state.getBlackScore()>0) {
			return true;
		}
		return false;
	}
	
	public static boolean blackWins(BoardState state) {
		if(state.getBlackScore()-state.getWhiteScore()>0) {
			return true;
		}
		return false;
	}
	...
	public static int evaluate(BoardState boardState, int maximizingColor, int whitePoints, int blackPoints, boolean isTerminal) {
...
//		if(isTerminal) {
//			if(maximizingColor == 0 && whiteWins(boardState) || maximizingColor == 1 && blackWins(boardState)) {
//				return 100+Math.abs(whitePoints-blackPoints);
//			}
//			else {
//				return  -100-Math.abs(whitePoints-blackPoints);
//			}
